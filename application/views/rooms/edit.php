...
<h2><?php echo lang('rooms_edit_title');?>&nbsp;<col-md- class="muted">(<?php echo $room['name']; ?>)</col-md-></h2>
...
<?php echo form_open('locations/' . $room['location_id'] . '/rooms/' . $room['id'] . '/edit') ?>
    ...
    <br /><br />
    <button type="submit" class="btn btn-primary"><i class="glyphicon-ok glyphicon-white"></i>&nbsp;<?php echo lang('rooms_edit_button_update');?></button>
    &nbsp;
    <a href="<?php echo base_url();?>locations/<?php echo $room['location_id']; ?>/rooms" class="btn btn-danger"><i class="glyphicon-remove glyphicon-white"></i>&nbsp;<?php echo lang('rooms_edit_button_cancel');?></a>
</form>

...
echo form_open('locations/' . $location . '/rooms/create', $attributes); ?>
    ...
    <br /><br />
    <button id="send" class="btn btn-primary"><i class="glyphicon-ok glyphicon-white"></i>&nbsp;<?php echo lang('rooms_create_button_create');?></button>
    &nbsp;
    <a href="<?php echo base_url(); ?>locations/<?php echo $location; ?>/rooms" class="btn btn-danger"><i class="glyphicon-remove glyphicon-white"></i>&nbsp;<?php echo lang('rooms_create_button_cancel');?></a>
</form>

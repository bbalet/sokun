...
<h2><?php echo lang('rooms_status_title');?>&nbsp;<col-md- class="muted">(<?php echo $room['name']; ?>)</col-md-></h2>
...
<div class="row-fluid">
    <div class="col-md-12">
        <a href="<?php echo base_url();?>locations/<?php echo $room['location_id']; ?>/rooms" class="btn btn-primary"><i class="glyphicon-arrow-left glyphicon-white"></i>&nbsp;<?php echo lang('rooms_status_button_back');?></a>
        <a href="<?php echo base_url();?>rooms/calendar/<?php echo $room['id']; ?>" class="btn btn-primary"><i class="glyphicon-calendar glyphicon-white"></i>&nbsp;<?php echo lang('rooms_status_button_calendar');?></a>
    </div>
</div>

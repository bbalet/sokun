...
echo form_open('rooms/book/' . $room['id'], $attributes); ?>
    ...
    <br /><br />
    <button id="send" class="btn btn-primary"><i class="glyphicon-ok glyphicon-white"></i>&nbsp;<?php echo lang('rooms_book_button_book');?></button>
    &nbsp;
    <a href="<?php echo base_url(); ?>locations/<?php echo $room['location_id']; ?>/rooms" class="btn btn-danger"><i class="glyphicon-remove glyphicon-white"></i>&nbsp;<?php echo lang('rooms_book_button_cancel');?></a>
</form>

...
<h1><?php echo lang('rooms_index_title');?> <col-md- class="muted">(<?php echo $location['name']; ?>)</col-md-></h1>
    ...
    <tr>
        <td data-order="<?php echo $room['id']; ?>">
            ...
            <div class="pull-right">
                ...
                <a href="#" class="confirm-delete" data-id="<?php echo $room['id'];?>" title="<?php echo lang('rooms_index_tooltip_delete');?>"><i class="glyphicon-trash"></i></a>&nbsp; 
                <a href="<?php echo base_url();?>locations/<?php echo $location['id']; ?>/rooms/<?php echo $room['id']; ?>/edit" title="<?php echo lang('rooms_index_tooltip_edit');?>"><i class="glyphicon-pencil"></i></a>
                <?php } ?>
                <a href="<?php echo base_url();?>rooms/<?php echo $room['id'];?>/timeslots" title="<?php echo lang('rooms_index_tooltip_timeslot');?>"><i class="glyphicon-list-alt"></i></a>&nbsp;
                <a href="<?php echo base_url();?>rooms/calendar/<?php echo $room['id'];?>" title="<?php echo lang('rooms_index_tooltip_calendar');?>"><i class="glyphicon-calendar"></i></a>&nbsp;
                <a href="#" class="qrcode-modal" data-id="<?php echo $room['id'];?>" role="button" data-toggle="modal" title="<?php echo lang('rooms_index_tooltip_qrcode');?>"><i class="glyphicon-qrcode"></i></a>&nbsp;
                <a href="<?php echo base_url();?>rooms/book/<?php echo $room['id'];?>" title="<?php echo lang('rooms_index_tooltip_book');?>"><i class="glyphicon-book"></i></a>&nbsp;
                <?php if ($room['free']) { ?>
                <a href="<?php echo base_url();?>rooms/status/<?php echo $room['id'];?>" title="<?php echo lang('rooms_index_tooltip_available');?>"><i class="glyphicon-ok-circle"></i></a>&nbsp;
                <?php } else { ?>
                <a href="<?php echo base_url();?>rooms/status/<?php echo $room['id'];?>" title="<?php echo lang('rooms_index_tooltip_booked');?>"><i class="glyphicon-ban-circle"></i></a>&nbsp;
                <?php } ?>
...
<div class="row-fluid">
    <div class="col-md-12">
      <a href="<?php echo base_url();?>locations" class="btn btn-primary"><i class="glyphicon-arrow-left glyphicon-white"></i>&nbsp;<?php echo lang('rooms_index_button_back');?></a>&nbsp;
      <a href="<?php echo base_url();?>locations/<?php echo $location['id']; ?>/rooms/export" class="btn btn-primary"><i class="glyphicon-file glyphicon-white"></i>&nbsp;<?php echo lang('rooms_index_button_export');?></a>&nbsp;
      <?php if ($is_admin == TRUE) { ?>
      <a href="<?php echo base_url();?>locations/<?php echo $location['id']; ?>/rooms/create" class="btn btn-primary"><i class="glyphicon-plus-sign glyphicon-white"></i>&nbsp;<?php echo lang('rooms_index_button_create');?></a>
      <?php } ?>
    </div>
</div>
